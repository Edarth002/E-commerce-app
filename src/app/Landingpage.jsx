        ...
        <nav className="flex items-center justify-between md:border-b md:pb-7 border-Grayishblue md:px-0 md:py-0 px-10 pt-5">
          <div className="flex space-x-7 items-center">
            ...
            <div className="items-center md:space-x-5 md:flex hidden">
              <a href="/" className="hover:text-orange-400 hover:font-semibold">
                Collections
              </a>
              <a href="/" className="hover:text-orange-400 hover:font-semibold">
                Men
          ...
          {menu && (
            <div className="bg-white w-4/5 md:hidden p-10 h-screen inset-0 fixed z-50">
                  ...
                  <div className="p-5">
                    <button
                      onClick={() => {
                        handleCartDel();
                        alert(
                          "You have succesfully made a purchase😉😉😉😉 and will be redirected back home shortly If you are not redirected, click on the home icon on your browser We hope to see you back soon."
                        );
                      }}
